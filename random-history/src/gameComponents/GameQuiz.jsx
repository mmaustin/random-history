...
import { questionsAnswers } from "./gameObjects";

const GameQuiz = ({score, setShowQuiz, setScore, amount, setAmount, startQuizNumber, displayNextBoard, colorProp, setColorProp, correctAnswers, wrongTwice, setCorrectAnswers, setWrongTwice}) => {
